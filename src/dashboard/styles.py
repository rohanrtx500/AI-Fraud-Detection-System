...
def render_custom_sidebar():
    ...
    # Render Navigation links for all pages (Simplified Business Language)
    nav_container.markdown("### 🧭 Navigation")
    nav_container.page_link("App.py", label="Home Cockpit", icon="🛡️")
    nav_container.page_link("pages/1_Realtime_Alerts.py", label="Live Payment Evaluation", icon="🚨")
    nav_container.page_link("pages/2_Analytics.py", label="Payment & Risk Analytics", icon="📊")
    nav_container.page_link("pages/3_Explainability.py", label="Risk Decision Explanations", icon="🔎")
    nav_container.page_link("pages/3_Graph_Analysis.py", label="Connected Fraud Rings", icon="🕸️")
    nav_container.page_link("pages/4_Cases.py", label="Case Management", icon="💼")
    nav_container.page_link("pages/5_Monitoring.py", label="Model Health & Integrity", icon="🔍")
    nav_container.page_link("pages/6_Reports.py", label="Executive Audit Reports", icon="📑")
    nav_container.page_link("pages/7_Simulation.py", label="Traffic & Stress Test Desk", icon="⚡")
    nav_container.page_link("pages/8_Threat_Intel.py", label="Blocked Threat Manager", icon="📡")
    nav_container.page_link("pages/9_Governance.py", label="System Activity Logs", icon="⚖️")
